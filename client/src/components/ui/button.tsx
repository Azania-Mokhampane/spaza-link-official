  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        landing:
          "bg-primary text-primary-foreground hover:bg-primary/85 active:bg-primary/75 text-base font-semibold rounded-lg shadow-sm",
        landingOutline:
          "border-2 border-primary text-primary bg-background hover:bg-primary/5 active:bg-primary/10 text-base font-semibold rounded-lg",
      },
      size: {
        default: "h-10 px-4 py-2 rounded-full",
        sm: "h-9 px-3",
        lg: "h-11 rounded-full px-8",
        xl: "h-14 rounded-full px-6 py-4 text-base ",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
